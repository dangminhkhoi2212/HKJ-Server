...
import static com.server.hkj.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static com.server.hkj.test.util.OAuth2TestUtil.registerAuthenticationToken;
import static com.server.hkj.test.util.OAuth2TestUtil.testAuthenticationToken;
