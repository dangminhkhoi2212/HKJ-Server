...
import static com.server.hkj.domain.ApplicationUserAsserts.*;
...
class ApplicationUserResourceIT {
    ...
    private static final String DEFAULT_PHONE_NUMBER = "8469945519";
    private static final String UPDATED_PHONE_NUMBER = "0750751272";
