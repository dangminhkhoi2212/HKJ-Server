...
import reducer, {
  ...
  reset,
  updateEntity,
} from './hkj-jewelry-model.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HKJJEWELRYMODEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HKJJEWELRYMODEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HKJJEWELRYMODEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HKJJEWELRYMODEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HKJJEWELRYMODEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HKJJEWELRYMODEL actions', async () => {
      const arg = 42666;
