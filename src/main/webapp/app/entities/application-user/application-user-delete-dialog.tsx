...
export const ApplicationUserDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="serverApp.applicationUser.delete.question">
        <Translate contentKey="serverApp.applicationUser.delete.question" interpolate={{ id: applicationUserEntity.id }}>
