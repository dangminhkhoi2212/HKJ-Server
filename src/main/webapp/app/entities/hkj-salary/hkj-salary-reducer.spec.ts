...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HKJSALARY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HKJSALARY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HKJSALARY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HKJSALARY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HKJSALARY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HKJSALARY actions', async () => {
      const arg = 42666;
