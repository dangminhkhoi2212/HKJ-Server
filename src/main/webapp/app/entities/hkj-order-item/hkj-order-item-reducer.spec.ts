...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HKJORDERITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HKJORDERITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HKJORDERITEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HKJORDERITEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HKJORDERITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HKJORDERITEM actions', async () => {
      const arg = 42666;
