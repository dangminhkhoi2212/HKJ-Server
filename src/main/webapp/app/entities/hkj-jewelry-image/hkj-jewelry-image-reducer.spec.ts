...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './hkj-jewelry-image.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HKJJEWELRYIMAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HKJJEWELRYIMAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HKJJEWELRYIMAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HKJJEWELRYIMAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HKJJEWELRYIMAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HKJJEWELRYIMAGE actions', async () => {
      const arg = 42666;
