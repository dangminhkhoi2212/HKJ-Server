...
import reducer, {
  ...
  reset,
  updateEntity,
} from './hkj-track-search-image.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HKJTRACKSEARCHIMAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HKJTRACKSEARCHIMAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HKJTRACKSEARCHIMAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HKJTRACKSEARCHIMAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HKJTRACKSEARCHIMAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HKJTRACKSEARCHIMAGE actions', async () => {
      const arg = 42666;
