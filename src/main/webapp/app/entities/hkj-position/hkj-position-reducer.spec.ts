...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HKJPOSITION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HKJPOSITION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HKJPOSITION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HKJPOSITION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HKJPOSITION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HKJPOSITION actions', async () => {
      const arg = 42666;
