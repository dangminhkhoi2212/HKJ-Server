...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './hkj-order.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HKJORDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HKJORDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HKJORDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HKJORDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HKJORDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HKJORDER actions', async () => {
      const arg = 42666;
