...
import reducer, {
  ...
  reset,
  updateEntity,
} from './hkj-material-image.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HKJMATERIALIMAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HKJMATERIALIMAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HKJMATERIALIMAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HKJMATERIALIMAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HKJMATERIALIMAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HKJMATERIALIMAGE actions', async () => {
      const arg = 42666;
