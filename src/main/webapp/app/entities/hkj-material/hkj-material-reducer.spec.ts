...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HKJMATERIAL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HKJMATERIAL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HKJMATERIAL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HKJMATERIAL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HKJMATERIAL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HKJMATERIAL actions', async () => {
      const arg = 42666;
