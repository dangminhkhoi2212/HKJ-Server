...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HKJORDERIMAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HKJORDERIMAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HKJORDERIMAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HKJORDERIMAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HKJORDERIMAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HKJORDERIMAGE actions', async () => {
      const arg = 42666;
