...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './hkj-task.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HKJTASK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HKJTASK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HKJTASK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HKJTASK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HKJTASK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HKJTASK actions', async () => {
      const arg = 42666;
