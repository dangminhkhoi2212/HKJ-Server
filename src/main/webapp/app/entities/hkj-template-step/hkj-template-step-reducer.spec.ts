...
import reducer, {
  ...
  reset,
  updateEntity,
} from './hkj-template-step.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HKJTEMPLATESTEP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HKJTEMPLATESTEP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HKJTEMPLATESTEP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HKJTEMPLATESTEP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HKJTEMPLATESTEP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HKJTEMPLATESTEP actions', async () => {
      const arg = 42666;
