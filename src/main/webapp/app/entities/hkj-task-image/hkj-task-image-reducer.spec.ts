...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HKJTASKIMAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HKJTASKIMAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HKJTASKIMAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HKJTASKIMAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HKJTASKIMAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HKJTASKIMAGE actions', async () => {
      const arg = 42666;
