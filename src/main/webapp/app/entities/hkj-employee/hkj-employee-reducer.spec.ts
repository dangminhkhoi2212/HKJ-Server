...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HKJEMPLOYEE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HKJEMPLOYEE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HKJEMPLOYEE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HKJEMPLOYEE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HKJEMPLOYEE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HKJEMPLOYEE actions', async () => {
      const arg = 42666;
