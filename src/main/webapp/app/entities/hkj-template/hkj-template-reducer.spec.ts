...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HKJTEMPLATE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HKJTEMPLATE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HKJTEMPLATE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HKJTEMPLATE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HKJTEMPLATE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HKJTEMPLATE actions', async () => {
      const arg = 42666;
