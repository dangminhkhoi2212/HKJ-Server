...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HKJTEMPIMAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HKJTEMPIMAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HKJTEMPIMAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HKJTEMPIMAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HKJTEMPIMAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HKJTEMPIMAGE actions', async () => {
      const arg = 42666;
