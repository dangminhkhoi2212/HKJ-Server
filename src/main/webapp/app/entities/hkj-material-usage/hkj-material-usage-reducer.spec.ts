...
import reducer, {
  ...
  reset,
  updateEntity,
} from './hkj-material-usage.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HKJMATERIALUSAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HKJMATERIALUSAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HKJMATERIALUSAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HKJMATERIALUSAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HKJMATERIALUSAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HKJMATERIALUSAGE actions', async () => {
      const arg = 42666;
