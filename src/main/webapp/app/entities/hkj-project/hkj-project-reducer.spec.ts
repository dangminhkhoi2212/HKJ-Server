...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HKJPROJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HKJPROJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HKJPROJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HKJPROJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HKJPROJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HKJPROJECT actions', async () => {
      const arg = 42666;
