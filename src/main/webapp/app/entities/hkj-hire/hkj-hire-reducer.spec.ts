...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './hkj-hire.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HKJHIRE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HKJHIRE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HKJHIRE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HKJHIRE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HKJHIRE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HKJHIRE actions', async () => {
      const arg = 42666;
