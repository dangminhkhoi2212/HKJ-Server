...
const EntitiesMenu = () => {
  return (
    <>
      ...
      <MenuItem icon="asterisk" to="/hkj-material-image">
        <Translate contentKey="global.menu.entities.hkjMaterialImage" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/hkj-track-search-image">
        <Translate contentKey="global.menu.entities.hkjTrackSearchImage" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/hkj-cart">
        <Translate contentKey="global.menu.entities.hkjCart" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/hkj-order-item">
        <Translate contentKey="global.menu.entities.hkjOrderItem" />
      </MenuItem>
