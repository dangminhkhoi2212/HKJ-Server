...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './hkj-cart.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HKJCART_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HKJCART actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HKJCART actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HKJCART actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HKJCART actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HKJCART actions', async () => {
      const arg = 42666;
