...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HKJCATEGORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HKJCATEGORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HKJCATEGORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HKJCATEGORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HKJCATEGORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HKJCATEGORY actions', async () => {
      const arg = 42666;
