...
/**
 * Criteria class for the {@link com.server.hkj.domain.HkjTemplateStep} entity. This class is used
 * in {@link com.server.hkj.web.rest.HkjTemplateStepResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /hkj-template-steps?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class HkjTemplateStepCriteria implements Serializable, Criteria {
    ...
    public HkjTemplateStepCriteria() {}

    public HkjTemplateStepCriteria(HkjTemplateStepCriteria other) {
    ...
    @Override
    public HkjTemplateStepCriteria copy() {
        return new HkjTemplateStepCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final HkjTemplateStepCriteria that = (HkjTemplateStepCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, createdBy, createdDate, lastModifiedBy, lastModifiedDate, hkjTaskId, hkjTemplateId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "HkjTemplateStepCriteria{" +
