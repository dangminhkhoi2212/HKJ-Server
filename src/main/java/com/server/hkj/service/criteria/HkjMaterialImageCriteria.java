...
/**
 * Criteria class for the {@link com.server.hkj.domain.HkjMaterialImage} entity. This class is used
 * in {@link com.server.hkj.web.rest.HkjMaterialImageResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /hkj-material-images?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class HkjMaterialImageCriteria implements Serializable, Criteria {
    ...
    public HkjMaterialImageCriteria() {}

    public HkjMaterialImageCriteria(HkjMaterialImageCriteria other) {
    ...
    @Override
    public HkjMaterialImageCriteria copy() {
        return new HkjMaterialImageCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final HkjMaterialImageCriteria that = (HkjMaterialImageCriteria) o;
        return (
    ...
    public String toString() {
        return "HkjMaterialImageCriteria{" +
